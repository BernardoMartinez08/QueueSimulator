...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtServer->Location = System::Drawing::Point(367, 17);
			...
			this->txtCliente->Location = System::Drawing::Point(0, 58);
...
#pragma endregion
	...
	private: void crearServer() {
		...
		Server->Location = System::Drawing::Point(367, (YUltimoServer + 63));
		YUltimoServer += 63;
	...
	private: void crearCliente() {
		...
		Cliente->Location = System::Drawing::Point(0 , 58);
	...
	private: void actualizarEstadoCliente(PictureBox^ cliente, string estado) {
		if (estado == "ENTRANDO") {
			String^ imagen = " ";
			imagen = "C:/Users/angie/Desktop/ImagenesNodos/ClientesCola/Llegando.png";
	...
	private: void actualizarEstadoCliente(TextBox^ cliente, string estado) {
		if (estado == "ENTRANDO") {
			cliente->BackColor = Color().Green;
		}
		else if (estado == "EN COLA") {
			cliente->BackColor = Color().Yellow;
		}
		else if (estado == "EN CAJA") {
			cliente->BackColor = Color().Orange;
		}
		else if (estado == "SALIENDO") {
			cliente->BackColor = Color().Red;
			if(cliente->Location.X >= picSalida->Location.X)
				delete cliente;
		}
	}
};
